...
#ifndef PARTICLES_LP_RAISE
  #define PARTICLES_LP_RAISE   NO 
#endif
...
#ifndef PARTICLES_RESTART_THRESHOLD
  #define PARTICLES_RESTART_THRESHOLD 0.005
#endif

/* Particle random deviation settings */
#define PARTICLES_RANDOM_NONE 0
#define PARTICLES_RANDOM_UNIFORM 1
#define PARTICLES_RANDOM_GAUSSIAN 2

/* Particle Gaussian deviation factor */
#ifndef PARTICLES_RANDOM_GAUSSIAN_FACTOR
  #define PARTICLES_RANDOM_GAUSSIAN_FACTOR 0.5
#endif

#ifndef PARTICLES_RANDOM_MODE
  #define PARTICLES_RANDOM_MODE PARTICLES_RANDOM_GAUSSIAN
#endif

#ifndef PARTICLES_INJECT_IN_BATCHES
  #define PARTICLES_INJECT_IN_BATCHES YES
#endif
...
/* *********************************************************************
  ...
  #ifndef PARTICLES_LP_SHK_BINS
    #define PARTICLES_LP_SHK_BINS 3
  #endif

  #ifndef PARTICLES_LP_SHK_THRESH_MAX
    #define PARTICLES_LP_SHK_THRESH_MAX 5.0
  #endif

  #ifndef PARTICLES_LP_SHK_THRESH_MIN
...
/* *********************************************************************
    Flag shock structure
   ********************************************************************* */
double ****particle_flag_shock;
...
#if (PARTICLES_TYPE == LAGRANGIAN) && ((PARTICLES_LP_SPECTRA == NO) && (PARTICLES_LP_RAISE == NO))
typedef struct Particle_{
  double coord[3];     /**< Particle coordinates */
  double speed[3];     /**< Particle velocity */
  double coord_old[3]; /**< Particle coordinates at previous time level */
...
typedef struct Particle_{
  ...
  double pressure;     /**< Particle pressure */
  double tracer[NTRACER]; /**< Particle tracer values */
  float  last_shock_time[PARTICLES_LP_SHK_BINS]; /**< Particle last shock time */
  float  tinj;         /**< Particle injection time */  
  float  color;        /**< User-supplied real number to distinguish particles */
  int    cell[3];      /**< Indices (i,j,k) of the cell hosting the particle */
  uint32_t id;         /**< Particle id. Numbering is sequential for each rank */
...
void    Particles_LP_FlagShock(Data *, double ****, Grid *);  
void    Particles_LP_InitShock();
#endif
...
void    Particles_Restart(Runtime *, Data *, Grid *);
...
void    Particles_WriteVTK   (particleNode*, Output *, char filename[]);
 ...
 /* Jet related routines */
void Particles_SetJetProperties(JetInjectionRegionProperties*, JetInjectionRegionProperties*, JetIntermittencyProperties*);
int Particles_JetEnabled();
int Particles_WithinJetInjectionZone(double, double, double);
void Particles_InjectJetParticlesBatches(Data*, Grid*);
void Particles_InjectJetParticlesStream(Data*, Grid*);
